...
class Square:
    ...
    def __eq__(self, other):
        """Function to compare equal to operation
        with other similar objects.

        Args:
            self: object instance reference to itself.
            other: Another object instance of the same class
        """
        return self.area() == other.area()

    def __ne__(self, other):
        """Function to compare not equal to operation
        with other similar objects.
    ...
    def __gt__(self, other):
        """Function to greater than operation
        with other similar objects.
    ...
    def __ge__(self, other):
        """Function to compare greater than or equal to operation
        with other similar objects.
    ...
    def __lt__(self, other):
        """Function to compare less than operation
        with other similar objects.
    ...
    def __le__(self, other):
        """Function to compare less than or equal to operation
        with other similar objects.
